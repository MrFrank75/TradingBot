...
namespace TradingBot.GoogleServices
{
    public interface IGoogleSheetWriter
    {
        ...
        int  WritePriceLevelsRangeWithQuantitiesIntoSheetByRow(string sheetId, List<OrderBookCSVSnapshotEntry> priceLevelEntries, double lowPriceRange, double highPriceRange, double priceGranularity, double currentAssetPrice, int startingRow);
